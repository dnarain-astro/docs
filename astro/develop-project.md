...
To add Python packages from a private repository to your Astro project, specify the SSH URL to your repository in your project's `requirements.txt` file. For example, to clone a private repository named `mypackages`, you would add the following line to `requirements.txt`
