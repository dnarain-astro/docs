...
4. Configure the following values:
    ...
    - **Known Hosts**: The known_hosts for your Git provider, formatted as: `github.com <github_public_key>`. Please refer https://airflow.apache.org/docs/helm-chart/stable/production-guide.html#production-guide-knownhosts for generating github_public_key. we need to make sure to use same key type everywhere,add your public key in github settings section & ssh keys should be generated without passphrase.
