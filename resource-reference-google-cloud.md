---
sidebar_label: "Google Cloud Resource Reference"
title: "Resources Required for Astro on Google Cloud"
id: resource-reference-google-cloud
description: Reference of all supported configurations for new Clusters on Astro in Google CLoud.
---

## Overview

Unless otherwise specified, new Clusters on Astro are created with a set of default Google Cloud resources that our team has deemed appropriate for most use cases.
...
| ----------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| [EKS Cluster](https://cloud.google.com/fixthislink) | An EKS cluster is required to run the Astro Data Plane, which hosts the resources and data required to execute Airflow tasks. | 1x                      |
